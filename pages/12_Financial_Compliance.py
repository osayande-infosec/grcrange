...
from cyberresilient.theme import (
    ...
    page_header, section_header, footer,
)
...
page_header(
    "Financial Compliance — PCI DSS, SOX ITGC & FAIR Risk",
    "PCI DSS v4.0, SOX IT General Controls compliance and quantitative risk analysis",
    icon="🏦",
)
