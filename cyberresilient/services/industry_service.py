...
INDUSTRY_PROFILES: dict[str, dict] = {
    "healthcare": {
        "label": "Healthcare",
        "icon": "🏥",
        "frameworks": ["nist_csf", "iso27001", "hipaa", "hitrust", "gdpr", "pipeda"],
        "primary_frameworks": ["hipaa", "gdpr", "pipeda"],
        "risk_categories": [
        ...
        "catalogue_files": [
            ...
            "controls_hipaa.json",
            "controls_privacy_health.json",
        ],
        "report_templates": [
            "executive_brief", "risk_register", "compliance_summary",
            "hipaa_risk_analysis", "breach_notification", "privacy_posture",
        ],
    },
